		...
		<div className="h-[75vh] flex flex-col md:flex-row items-center justify-center">
			<div className="w-full mb-12 md:mb-0 lg:w-3/6 flex flex-col items-center lg:items-start justify-center">
				<h1 className="text-4xl lg:text-6xl font-semibold text-yellow-100 text-center lg:text-left">
					Student-Friendly Second-Hand Books
				</h1>
				<p className="mt-4 text-xl text-zinc-300 text-center lg:text-left">
					Get affordable second-hand books, study materials, and notes curated
					especially for students. Save money while learning smarter.
				</p>
				<div className="mt-8">
					<Link
						to="/all-books"
			...
			<div className="w-full lg:w-3/6 h-auto lg:h-[100%] flex items-center justify-center">
				<img
					src="./hero.png"
					alt="hero"
					className="max-w-[60%] lg:max-w-[80%] rounded-lg"
				/>
			</div>
		</div>
	);
